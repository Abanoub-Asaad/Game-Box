...
public abstract class Sprite extends Region {
    ...
    /**
     * Standard movement method: calculate valocity depending on accumulated
     * acceleration force, then calculate the location. Reset acceleration so
     * that it can be recalculated in the next animation step.
     */
    public void move() {
